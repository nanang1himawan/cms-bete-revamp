...
<head>
    ...
    <link href="../css/style_workshop.css" rel="stylesheet">
...
try {
    ...
    $message .= "Telephone: " . $_POST['telephone'] . "<br /><br />";
    $message .= "Participation options: " . $_POST['question_1'];

	// Get the email's html content
    $email_html = file_get_contents('template-email/template-email-workshop.html');
    ...
    // Get the email's html content
    $email_html_confirm = file_get_contents('template-email/confirmation-email-workshop.html');
