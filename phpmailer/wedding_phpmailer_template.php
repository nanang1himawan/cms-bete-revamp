...
try {
    ...
    $message .= "Child: " . $_POST['child'] . "<br />";
    $message .= "Additional notes: " . $_POST['additional_notes'] . "<br />";
    ...
    // Get the email's html content
    $email_html_confirm = file_get_contents('template-email/confirmation-email-wedding.html');
