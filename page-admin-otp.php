        ...
        <div class="main p-2 py-3 p-xl-5">
            ...
            <div class="body d-flex p-0 p-xl-5">
                <div class="container-xxl">
                    <div class="row g-3">
                        <div class="d-flex justify-content-center align-items-center auth-h100 auth-h1001">
                                            ...
                                            <div class="card-body p-4">
                                                <form action="loginWithOtp" method="POST"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input required name="otp" placeholder="PIN" type="number"
                                                            class="form-control">
                                                    </div>
                                                    <!-- <div class="mb-3">
                                                    ...
                                                    <button type="submit" name="submitLogin"
                                                        class="btn btn-primary text-uppercase py-2 fs-5 w-100 mt-2">log
                                                        in</button>
                                                </form>
                                            </div>
                                        </div>
