  ...
  (function (n) {
    ...
    function B(t) {
      ...
      A.__browser ||
        ...
        n.remove()),
        P.extend(t.oBrowser, A.__browser),
        (t.oScroll.iBarWidth = A.__browser.barWidth);
    }
    ...
    function U(t, e) {
      ...
      t.aoColumns.push(n),
        ((n = t.aoPreSearchCols)[a] = P.extend({}, A.models.oSearch, n[a])),
        V(t, a, P(e).data());
    }
    function V(t, e, n) {
      e = t.aoColumns[e];
        ...
        for (r = e.length - 1; 0 <= r; r--)
          for (
            var i = e[r],
              ...
              l = 0,
              c = (s = Array.isArray(s) ? s : [s]).length;
            l < c;
            l++
          )
            if ("number" == typeof s[l] && 0 <= s[l]) {
              ...
              for (var u = 0, d = o.length; u < d; u++)
                ("_all" != s[l] && !P(o[u].nTh).hasClass(s[l])) || a(u, i);
    ...
    function _(t, e, n, a) {
      ...
      return (
        ...
        (!n && t.oFeatures.bDeferRender) || tt(t, r, n, a),
        r
      );
    }
    function z(n, t) {
    ...
    function p(a) {
      ...
      return P.isPlainObject(a)
        ...
        : ((l = function (t, e, n) {
            for (
              var a, r, o = (n = J(n))[n.length - 1], i = 0, s = n.length - 1;
              i < s;
              i++
            ) {
              if ("__proto__" === n[i])
    ...
    function K(t, e, n, a) {
        ...
        (n !== R && n !== u) ||
          ...
          i && i._bAttrSrc
            ? (p(i.mData._)(a, s),
              ...
              r(i.mData.filter, t))
            : f
            ? (i._setter || (i._setter = p(i.mData)), i._setter(a, s))
            : (a[u] = s)),
          u++;
      }
      var i,
      ...
      else for (c = 0, h = (l = e.anCells).length; c < h; c++) o(l[c]);
      return (
    ...
    function tt(t, e, n, a) {
      ...
      if (null === o.nTr) {
        for (
          var l = n || v.createElement("tr"),
            c =
              ((o.nTr = l), (o.anCells = s), (l._DT_RowIndex = e), et(t, o), 0),
          ...
          (f._DT_CellIndex = { row: e, column: c }),
            s.push(f),
            (!r &&
              ((n && !d.mRender && d.mData === c) ||
                (P.isPlainObject(d.mData) && d.mData._ === c + ".display"))) ||
              (f.innerHTML = y(t, e, c, "display")),
            d.sClass && (f.className += " " + d.sClass),
            d.bVisible && !n
              ? l.appendChild(f)
              : !d.bVisible && n && f.parentNode.removeChild(f),
            d.fnCreatedCell &&
              d.fnCreatedCell.call(t.oInstance, f, y(t, e, c), i, e, c);
        }
    ...
    function et(t, e) {
      ...
      n &&
        ...
        a.DT_RowClass &&
          ...
          (e.__rowc = e.__rowc ? _e(e.__rowc.concat(t)) : t),
    ...
    function nt(t) {
      for (
        var e,
          n = t.nTHead,
          a = t.nTFoot,
          r = 0 === P("th, td", n).length,
          o = t.oClasses,
          i = t.aoColumns,
          s = (r && (e = P("<tr/>").appendTo(n)), 0),
          l = i.length;
        s < l;
        s++
      ) {
        ...
        r && u.appendTo(e),
          t.oFeatures.bSort &&
            (u.addClass(c.sSortingClass), !1 !== c.bSortable) &&
            (u.attr("tabindex", t.iTabIndex).attr("aria-controls", t.sTableId),
            Mt(t, c.nTh, s)),
          c.sTitle != u[0].innerHTML && u.html(c.sTitle),
          Jt(t, "header")(t, u, c, o);
      }
      if (
        (r && ot(t.aoHeader, n),
        P(n).children("tr").attr("role", "row"),
        P(n).children("tr").children("th, td").addClass(o.sHeaderTH),
        P(a).children("tr").children("th, td").addClass(o.sFooterTH),
        null !== a)
      )
        for (l = (t = t.aoFooter[(s = 0)]).length; s < l; s++)
          ((c = i[s]).nTf = t[s].cell), c.sClass && P(c.nTf).addClass(c.sClass);
    }
    function at(t, e, n) {
      var a,
        r = [],
      ...
      if (-1 !== P.inArray(!1, e)) g(t, !1);
        ...
        var e = [],
          ...
          c =
            ...
            i !== R &&
              -1 !== i &&
              ((t._iDisplayStart = !s && i >= t.fnRecordsDisplay() ? 0 : i),
        ...
        if (0 !== l.length)
          for (o = s ? t.aoData.length : c, s = s ? 0 : i; s < o; s++) {
            ...
            0 !== r &&
              ((u = a[n % r]), f._sRowStripe != u) &&
              (P(h).removeClass(f._sRowStripe).addClass(u),
              (f._sRowStripe = u)),
              C(t, "aoRowCallback", null, [h, f._aData, n, s, d]),
              e.push(h),
              n++;
          }
        else
    ...
    function rt(t) {
      ...
      for (
        var o, i, s, l, c, u, d = t.sDom.split(""), f = 0;
        f < d.length;
        f++
      ) {
        if (((o = null), "<" == (i = d[f]))) {
          if (((s = P("<div/>")[0]), "'" == (l = d[f + 1]) || '"' == l)) {
            ...
            "H" == c ? (c = e.sJUIHeader) : "F" == c && (c = e.sJUIFooter),
              -1 != c.indexOf(".")
                ? ((l = c.split(".")),
                  (s.id = l[0].substr(1, l[0].length - 1)),
                  (s.className = l[1]))
                : "#" == c.charAt(0)
      ...
      for (n = 0, a = e.length; n < a; n++)
        for (var r = e[n], o = r.firstChild; o; ) {
          if (
            ...
            for (
              var i =
                  (i = +o.getAttribute("colspan")) && 0 != i && 1 != i ? i : 1,
                s =
                  (s = +o.getAttribute("rowspan")) && 0 != s && 1 != s ? s : 1,
                l = 0,
                c = t[n];
              c[l];
    ...
    function st(a, t, e) {
      ...
      C(a, "aoServerParams", "serverParams", [t]),
        t &&
          Array.isArray(t) &&
          ((r = {}),
          (o = /(.*?)\[\]$/),
    ...
    function ct(t) {
      ...
      for (
        var e = t.aoColumns,
          ...
          l = w(t),
          c = t._iDisplayStart,
          u = !1 !== r.bPaginate ? t._iDisplayLength : -1,
          d =
            (n("sEcho", t.iDraw),
            n("iColumns", a),
            n("sColumns", H(e, "sName").join(",")),
            n("iDisplayStart", c),
            n("iDisplayLength", u),
            {
              draw: t.iDraw,
        ...
        d.columns.push({
          ...
          n("mDataProp_" + c, u),
          r.bFilter &&
            (n("sSearch_" + c, h.sSearch),
            n("bRegex_" + c, h.bRegex),
            n("bSearchable_" + c, f.bSearchable)),
          r.bSort && n("bSortable_" + c, f.bSortable);
      }
      return (
        r.bFilter && (n("sSearch", o.sSearch), n("bRegex", o.bRegex)),
        r.bSort &&
          (P.each(l, function (t, e) {
            d.order.push({ column: e.col, dir: e.dir }),
              n("iSortCol_" + t, e.col),
              n("sSortDir_" + t, e.dir);
          }),
          n("iSortingCols", l.length)),
        null === (e = A.ext.legacy.ajax) ? (t.sAjaxSource ? s : d) : e ? s : d
      );
    }
    function ut(t, n) {
      var e = function (t, e) {
    ...
    function ht(t, e, n) {
      ...
      if ((b(t), "ssp" != I(t))) {
        for (
          bt(t, e.sSearch, n, r(e), e.bSmart, e.bCaseInsensitive), a(e), e = 0;
          e < i.length;
          e++
        )
          gt(t, i[e].sSearch, e, r(i[e]), i[e].bSmart, i[e].bCaseInsensitive);
        pt(t);
      } else a(e);
    ...
    function pt(t) {
      for (
        var e, n, a = A.ext.search, r = t.aiDisplay, o = 0, i = a.length;
        o < i;
        o++
      ) {
    ...
    function gt(t, e, n, a, r, o) {
      if ("" !== e) {
        var i = [],
          s = t.aiDisplay;
        for (a = mt(e, a, r, o), r = 0; r < s.length; r++)
    ...
    function _t(t) {
      ...
      return (
        n ||
          (t.aoDrawCallback.push({ fn: Dt, sName: "information" }),
    ...
    function xt(t, e) {
      (t._bInitComplete = !0),
        ...
        C(t, null, "plugin-init", [t, e]),
        C(t, "aoInitComplete", "init", [t, e]);
    }
    function Ct(t, e) {
      (e = parseInt(e, 10)),
        (t._iDisplayLength = e),
            ...
            fn: function (t) {
              if (l)
                for (
                  ...
                  Jt(t, "pageButton")(t, c.p[r], r, a, e, n);
              else s.fnUpdate(t, i);
            },
            sName: "pagination",
          })),
    ...
    function Ft(t) {
      ...
      return "" === f.sX && "" === f.sY
        ...
        : ((e = f.sX),
          (n = f.sY),
          (c = t.oClasses),
          (r = (a = d.children("caption")).length ? a[0]._captionSide : null),
          (o = P(d[0].cloneNode(!1))),
          (i = P(d[0].cloneNode(!1))),
          (s = d.children("tfoot")).length || (s = null),
          (o = P("<div/>", { class: c.sScrollWrapper })
            .append(
              P("<div/>", { class: c.sScrollHead })
                .css({
                  overflow: "hidden",
                  position: "relative",
                  border: 0,
                ...
                .append(
                  P("<div/>", { class: c.sScrollHeadInner })
                    .css({
                    ...
                    .append(
                      o
                        ...
                        .css("margin-left", 0)
                        .append("top" === r ? a : null)
                        .append(d.children("thead"))
                    )
                )
            )
            .append(
              P("<div/>", { class: c.sScrollBody })
                .css({
                  position: "relative",
                  overflow: "auto",
                  width: e ? k(e) : null,
          ...
          s &&
            o.append(
              P("<div/>", { class: c.sScrollFoot })
                ...
                .append(
                  P("<div/>", { class: c.sScrollFootInner }).append(
                    i
                      .removeAttr("id")
                      .css("margin-left", 0)
                      .append("bottom" === r ? a : null)
                      .append(d.children("tfoot"))
                  )
                )
            ),
          (l = (d = o.children())[0]),
          ...
          (u = s ? d[2] : null),
          e &&
            P(c).on("scroll.DT", function (t) {
              (t = this.scrollLeft),
                (l.scrollLeft = t),
                s && (u.scrollLeft = t);
            }),
          P(c).css("max-height", n),
          f.bCollapse || P(c).css("height", n),
          (t.nScrollHead = l),
          (t.nScrollBody = c),
          (t.nScrollFoot = u),
    ...
    function Pt(n) {
      ...
      n.scrollBarVis !== F && n.scrollBarVis !== R
        ? ((n.scrollBarVis = F), O(n))
        : ((n.scrollBarVis = F),
          S.children("thead, tfoot").remove(),
          w &&
            ((r = w.clone().prependTo(S)),
            (e = w.find("tr")),
            (r = r.find("tr"))),
          (o = v.clone().prependTo(S)),
          (v = v.find("tr")),
          (F = o.find("tr")),
          o.find("th, td").removeAttr("tabindex"),
          i || ((b.width = "100%"), (u[0].style.width = "100%")),
          P.each(it(n, o), function (t, e) {
          ...
          "" === i
            ? ((D.width = "100%"),
              x &&
                ...
                (D.width = k(S.outerWidth() - c)),
              (u = S.outerWidth()))
            : "" !== s && ((D.width = k(s)), (u = S.outerWidth())),
          $(t, F),
          $(function (t) {
          ...
          S.outerWidth() < u
            ? ((e =
              ...
              x &&
                ...
                (D.width = k(e - c)),
              ("" !== i && "" === s) ||
                E(n, 1, "Possible column misalignment", 6))
            : (e = "100%"),
          (b.width = k(e)),
          (d.width = k(e)),
          w && (n.nScrollFoot.style.width = k(e)),
          !l && x && (b.height = k(_.offsetHeight + c)),
          (i = S.outerWidth()),
          (h[0].style.width = k(i)),
          (f.width = k(i)),
          (s = S.height() > p.clientHeight || "scroll" == g.css("overflow-y")),
          (f[(l = "padding" + (T.bScrollbarLeft ? "Left" : "Right"))] = s
            ? c + "px"
            : "0px"),
          w &&
            ((y[0].style.width = k(i)),
            (m[0].style.width = k(i)),
            (m[0].style[l] = s ? c + "px" : "0px")),
    ...
    function Rt(t) {
      ...
      if (p || (!f && !o && !r && s == m(t) && s == c.length))
        for (e = 0; e < s; e++)
          null !== (l = N(t, e)) && (a[l].sWidth = k(c.eq(e).width()));
      else {
        (s = P(n).clone().css("visibility", "hidden").removeAttr("id"))
          .find("tbody tr")
          .remove();
        ...
        for (
          ...
          (g = a[l[e]]),
            (c[e].style.width =
              null !== g.sWidthOrig && "" !== g.sWidthOrig
                ? k(g.sWidthOrig)
                : ""),
            g.sWidthOrig &&
              o &&
        ...
        if (t.aoData.length)
          for (e = 0; e < l.length; e++)
            (g = a[(f = l[e])]),
              P(Nt(t, f)).clone(!1).append(g.sContentPadding).appendTo(b);
        for (
          P("[name]", s).removeAttr("name"),
            ...
            o && i
              ...
              ? (s.css("width", "auto"),
                s.removeAttr("width"),
                s.width() < d.clientWidth && u && s.width(d.clientWidth))
              : r
    ...
    function Nt(t, e) {
      ...
      return a < 0
        ...
        : (n = t.aoData[a]).nTr
        ? n.anCells[e]
        : P("<td/>").html(y(t, a, e, "display"))[0];
    }
    function $t(t, e) {
      for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)
        (n = (n = (n = y(t, o, e, "display") + "").replace(Ie, "")).replace(
          /&nbsp;/g,
          " "
    ...
    function Wt(t) {
      ...
      if (o.bSort && o.bSortClasses) {
        ...
        for (o = 0, e = r.length; o < e; o++)
          (i = r[o].src),
            P(H(t.aoData, "anCells", i)).addClass(a + (o < 2 ? o + 1 : 3));
      }
      t.aLastSort = r;
    }
    function Bt(t, e) {
      ...
      for (
        var o,
          i = A.ext.type.order[a.sType + "-pre"],
          s = 0,
          l = t.aoData.length;
        s < l;
        s++
      ...
      n.oFeatures.bStateSave &&
        ...
        ((t = {
          ...
          columns: P.map(n.aoColumns, function (t, e) {
            return { visible: t.bVisible, search: vt(n.aoPreSearchCols[e]) };
          }),
        }),
        C(n, "aoStateSaveParams", "stateSaveParams", [n, t]),
        (n.oSavedState = t),
        ...
        if (t && t.time) {
          ...
          if (
            ...
            if (
              ...
              t.search !== R && P.extend(n.oPreviousSearch, St(t.search)),
              t.columns)
            )
              for (r = 0, o = t.columns.length; r < o; r++)
                (e = t.columns[r]).visible !== R && (i[r].bVisible = e.visible),
                  e.search !== R &&
                    P.extend(n.aoPreSearchCols[r], St(e.search));
    ...
    function E(t, e, n, a) {
      if (
        ...
        L.console && console.log && console.log(n);
      else if (
        ((e = (e = A.ext).sErrMode || e.errMode),
        t && C(t, null, "error", [t, a, n]),
        "alert" == e)
      )
        alert(n);
      else {
    ...
    function Gt(t, e) {
      ...
      return (
        e <= n
          ? (t = d(0, e))
          : t <= a
          ? ((t = d(0, n - 2)).push("ellipsis"), t.push(e - 1))
          : (e - 1 - a <= t
              ? (t = d(e - (n - 2), e))
              : ((t = d(t - a + 2, t + a - 1)).push("ellipsis"), t.push(e - 1)),
    ...
    function Qt(e) {
      return function () {
        var t = [Xt(this[A.ext.iApiIndex])].concat(
    ...
    function ee(t, e, n) {
      return (
        !!o(t) ||
        ((o(t) || "string" == typeof t) && !!te(t.replace(be, ""), e, n)) ||
        null
      );
    }
    function ne(t, e, n, a) {
    ...
    function ie(t, e, n, a, r) {
      var o,
        ...
        l = typeof e;
      for (
        (e && "string" !== l && "function" !== l && e.length !== R) ||
          (e = [e]),
          l = 0,
          i = e.length;
        l < i;
        ...
        for (
          ...
          (o = n("string" == typeof c[u] ? c[u].trim() : c[u])) &&
            o.length &&
            (s = s.concat(o));
        ...
        if (Array.isArray(t) || t instanceof P)
          ...
          t.nodeName && "tr" === t.nodeName.toLowerCase()
            ...
            : ((n = P("<tr><td></td></tr>").addClass(e)),
              (P("td", n).addClass(e).html(t)[0].colSpan = m(r)),
              i.push(n[0]));
      }
      var i = [];
      o(e, n),
      ...
      a.length &&
        ...
        0 < H(o, "_details").length &&
          ...
          n.on("column-visibility.dt.DT_details", function (t, e, n, a) {
            if (r === e)
              for (e = m(e), n = 0, a = o.length; n < a; n++)
                (t = o[n])._details &&
    ...
    function fe(t, e, n, a) {
      return 0 === t || (t && "-" !== t)
        ? +(t =
            (t = e ? Se(t, e) : t).replace && (n && (t = t.replace(n, "")), a)
              ? t.replace(a, "")
              : t)
        : -1 / 0;
    }
    ...
    var f,
          ...
          this.each(function () {
            ...
            if ("table" != this.nodeName.toLowerCase())
              ...
              M(e),
                W(e.column),
                S(e, e, !0),
                S(e.column, e.column, !0),
                S(e, P.extend(n, o.data()), !0);
              ...
              (null !== t && "" !== t) ||
                (this.id = t = "DataTables_Table_" + A.ext._unique++);
              var u,
                d = P.extend(!0, {}, A.models.oSettings, {
                ...
                f =
                  ...
                  (d.oInit = n),
                  i.push(d),
                  (d.oInstance = 1 === m.length ? m : o.dataTable()),
                  M(n),
                  F(n.oLanguage),
                  n.aLengthMenu &&
                    !n.iDisplayLength &&
                  ...
                  T(d.oLanguage, n, "fnInfoCallback"),
                  x(d, "aoDrawCallback", n.fnDrawCallback, "user"),
                  x(d, "aoServerParams", n.fnServerParams, "user"),
                  x(d, "aoStateSaveParams", n.fnStateSaveParams, "user"),
                  x(d, "aoStateLoadParams", n.fnStateLoadParams, "user"),
                  x(d, "aoStateLoaded", n.fnStateLoaded, "user"),
                  x(d, "aoRowCallback", n.fnRowCallback, "user"),
                  x(d, "aoRowCreatedCallback", n.fnCreatedRow, "user"),
                  x(d, "aoHeaderCallback", n.fnHeaderCallback, "user"),
                  x(d, "aoFooterCallback", n.fnFooterCallback, "user"),
                  x(d, "aoInitComplete", n.fnInitComplete, "user"),
                  x(d, "aoPreDrawCallback", n.fnPreDrawCallback, "user"),
                  (d.rowIdFn = D(n.rowId)),
                  B(d),
                  d.oClasses),
                h =
                  (P.extend(f, A.ext.classes, n.oClasses),
                  o.addClass(f.sTable),
                  d.iInitDisplayStart === R &&
                    ((d.iInitDisplayStart = n.iDisplayStart),
                    (d._iDisplayStart = n.iDisplayStart)),
                  null !== n.iDeferLoading &&
                    ((d.bDeferLoading = !0),
                    (t = Array.isArray(n.iDeferLoading)),
                    (d._iRecordsDisplay = t
                      ? n.iDeferLoading[0]
                      : n.iDeferLoading),
                    (d._iRecordsTotal = t
                      ? n.iDeferLoading[1]
              ...
              if (
                (-1 !==
                  ...
                  (d.asDestroyStripes = t.slice())),
                (t = []),
                0 !== (i = this.getElementsByTagName("thead")).length &&
                  (ot(d.aoHeader, i[0]), (t = it(d))),
                null === n.aoColumns)
              )
                  ...
                  P(p[0])
                    ...
                    .each(function (t, e) {
                      var n,
                        a = d.aoColumns[t];
                      a.mData === t &&
                        ((n = u(e, "sort") || u(e, "order")),
                        (e = u(e, "filter") || u(e, "search")),
                        (null === n && null === e) ||
                          ((a.mData = {
                            _: t + ".display",
                ...
                t = function () {
                  if (n.aaSorting === R) {
                    ...
                    for (a = 0, s = t.length; a < s; a++)
                      t[a][1] = d.aoColumns[a].asSorting[0];
                  }
                  Wt(d),
                    g.bSort &&
                    ...
                    x(
                      ...
                      "aoDrawCallback",
                      function () {
                        (d.bSorted || "ssp" === I(d) || g.bDeferRender) &&
                          Wt(d);
                      },
                      "sc"
                    );
                  ...
                  if (
                    ...
                    0 ===
                      ...
                      : 0 < e.length &&
                        ((d.nTFoot = e[0]), ot(d.aoFooter, d.nTFoot)),
                    n.aaData)
                  )
                    for (a = 0; a < n.aaData.length; a++) _(d, n.aaData[a]);
                  else
                    (!d.bDeferLoading && "dom" != I(d)) ||
                      z(d, P(d.nTBody).children("tr"));
                  (d.aiDisplay = d.aiDisplayMaster.slice()),
                    !(d.bInitialised = !0) === r && Tt(d);
                };
              n.bStateSave
                ? ((g.bStateSave = !0),
                  x(d, "aoDrawCallback", Ut, "state_save"),
                  Vt(d, 0, t))
                : t();
            }
          }),
      ...
      Se = function (t, e) {
        return (
          pe[e] || (pe[e] = new RegExp(Te(e), "g")),
          "string" == typeof t && "." !== e
            ? t.replace(/\./g, "").replace(pe[e], ".")
            : t
        );
      },
      H = function (t, e, n) {
      ...
      De = function (t, e) {
        if (Array.isArray(e)) for (var n = 0; n < e.length; n++) De(t, e[n]);
        else t.push(e);
        return t;
      },
      a =
          ...
          iterator: function (t, e, n, a) {
            for (
              ...
              if ("table" === e) {
                ...
                (d = n.call(u, i[l], this[l], l)) !== R && o.push(d);
              else if (
                "column" === e ||
                "column-rows" === e ||
                "row" === e ||
                ...
                for (
                  var f = this[l],
                    h = ("column-rows" === e && (r = Le(i[l], s.opts)), 0),
                    p = f.length;
                  h < p;
                  h++
                )
                  (d = f[h]),
                    (d =
                      "cell" === e
                        ? n.call(u, i[l], d.row, d.column, l, h)
                        : n.call(u, i[l], d, l, h, r)) !== R && o.push(d);
            }
            return o.length || a
              ? (((e = (t = new j(i, t ? o.concat.apply([], o) : o))
                  .selector).rows = s.rows),
                (e.cols = s.cols),
                (e.opts = s.opts),
                t)
              : this;
              ...
              return ie(
                ...
                function (n) {
                  var t,
                    ...
                    a = r.aoData;
                  return (null !== e && !o) ||
                    ((i = i || Le(r, o)), null !== e && -1 !== P.inArray(e, i))
                    ? [e]
                    : null === n || n === R || "" === n
                    ? i
                    : "function" == typeof n
      ...
      Re =
          ...
          var e = this,
            t = this.iterator("column", function (t, e) {
              ...
              if (l !== R && n.bVisible !== l) {
                if (l)
                  for (
                    var r = P.inArray(!0, H(o, "bVisible"), e + 1),
                      o = 0,
                      i = a.length;
                    o < i;
                    o++
            ...
            l !== R &&
              this.iterator("table", function (t) {
                at(t, t.aoHeader),
                  at(t, t.aoFooter),
                  t.aiDisplay.length ||
                    P(t.nTBody).find("td[colspan]").attr("colspan", m(t)),
                  Ut(t),
                ...
                (e = this.iterator(
                  ...
                  function (t, e) {
                    for (t = [], r = 0, o = a[e].length; r < o; r++)
                      for (i = 0, s = n[e].length; i < s; i++)
                        t.push({ row: a[e][r], column: n[e][i] });
                    return t;
                  },
                  1
                )),
        ...
        e("cell().data()", function (t) {
          ...
          return t === R
            ? e.length && n.length
              ? y(e[0], n[0].row, n[0].column)
              : R
            : (Y(e[0], n[0].row, n[0].column, t),
        ...
        (A.versionCheck = A.fnVersionCheck =
          function (t) {
            for (
              var e,
                n,
        ...
        (A.isDataTable = A.fnIsDataTable =
          function (t) {
            var a = P(t).get(0),
              r = !1;
            return (
              t instanceof A.Api ||
              (P.each(A.settings, function (t, e) {
          ...
          function (e) {
            var t = !1,
              n =
                ...
                P.map(A.settings, function (t) {
                  if (!e || P(t.nTable).is(":visible")) return t.nTable;
                }));
            return t ? new j(n) : n;
          }),
        (A.camelToHungarian = S),
        e("$()", function (t, e) {
          return (
            (e = this.rows(e).nodes()),
            (e = P(e)),
        ...
        e("destroy()", function (d) {
          return (
            ...
            this.iterator("table", function (e) {
              ...
              (e.bDestroying = !0),
                C(e, "aoDestroyCallback", "destroy", [e]),
                d || new j(e).columns().visible(!0),
                c.off(".DT").find(":not(tbody *)").off(".DT"),
                P(L).off(".DT-" + e.sInstance),
                r != i.parentNode &&
                ...
                -1 !== (t = P.inArray(e, A.settings)) &&
                  A.settings.splice(t, 1);
            })
          );
        }),
    ...
    P.extend(Re, {
        ...
        pageButton: {
          _: function (l, t, c, e, u, d) {
            function f(t, e) {
              ...
              for (
                var a = g.sPageButtonDisabled, r = 0, o = e.length;
                r < o;
                r++
              ) {
                var i = e[r];
                if (Array.isArray(i)) {
                  ...
                  switch (((h = null), (p = i), (s = l.iTabIndex), i)) {
                    ...
                    case "last":
                      ...
                      break;
                    default:
                      (h = l.fnFormatNumber(i + 1)),
                        (p = u === i ? g.sPageButtonActive : "");
                  }
                  null !== h &&
                    (zt(
                      (s = P("<a>", {
      ...
      P.extend(A.ext.type.detect, [
        function (t, e) {
          return (e = e.oLanguage.sDecimal), te(t, e) ? "num" + e : null;
        },
        function (t, e) {
          return (!t || t instanceof Date || me.test(t)) &&
            ((null !== (e = Date.parse(t)) && !isNaN(e)) || o(t))
            ? "date"
            : null;
        },
        function (t, e) {
          return (
            (e = e.oLanguage.sDecimal), te(t, e, !0) ? "num-fmt" + e : null
          );
        },
        function (t, e) {
        ...
        function (t, e) {
          return (
            (e = e.oLanguage.sDecimal), ee(t, e, !0) ? "html-num-fmt" + e : null
          );
        },
        function (t, e) {
          return o(t) || ("string" == typeof t && -1 !== t.indexOf("<"))
            ? "html"
            : null;
        },
      ]),
    ...
    return (
      ...
      (((P.fn.dataTable = A).$ = P).fn.dataTableSettings = A.settings),
      (P.fn.dataTableExt = A.ext),
  ...
  (function (n) {
    ...
    return (
      ...
      (o.ext.renderer.pageButton.bootstrap = function (s, t, l, e, c, u) {
        ...
        d(v(t).empty().html('<ul class="pagination"/>').children("ul"), e),
          n !== r &&
            v(t)
              .find("[data-dt-idx=" + n + "]")
              .trigger("focus");
        ...
        (d.extend(n.prototype, {
          ...
          _resize: function () {
            ...
            t
              ...
              .each(function (t, e) {
                !0 === l[e] && u++,
                  l[e] !== i[e] && ((c = !0), n._setColumnVis(t, l[e]));
              }),
              c &&
                ...
                d("td", t.table().body()).eq(0).attr("colspan", u);
          },
