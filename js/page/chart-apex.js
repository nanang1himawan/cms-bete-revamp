...
$(document).ready(function () {
  ...
  new ApexCharts(
    document.querySelector("#apexspark-chart1"),
    options1
  ).render();
  ...
  new ApexCharts(
    document.querySelector("#apexspark-chart2"),
    options2
  ).render();
  ...
  new ApexCharts(
    document.querySelector("#apexspark-chart3"),
    options3
  ).render();
  ...
  new ApexCharts(
    document.querySelector("#apexspark-chart4"),
    options4
  ).render();
});
...
$(document).ready(function () {
  var listDate = [];
  var startDate = "2023-03-25";
  var endDate = "2023-04-10";
