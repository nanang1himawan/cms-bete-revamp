        ...
        <div class="main px-lg-4 px-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCategory">Add Category Event</button>
                    </ul>
                    <div class="tab-content">
                                ...
                                <tbody>
                                    ...
                                    foreach ($hasil as $data) {
                                        ...
                                        $name = $data["name"];
                                            ...
                                            echo "<tr>
                                                    <td>" . $name . "</td>
                                                    <td><button type=\"button\" class=\"btn btn-warning\" data-bs-toggle=\"modal\" data-bs-target=\"#editCategoryEvent" . $id . "\">Edit Data</button>
                                                ...
                                                <div class=\"modal fade\" id=\"editCategoryEvent" . $id . "\" tabindex=\"-1\"  aria-hidden=\"true\">
                                                    ...
                                                    <div class=\"modal-content\">
                                                        <div class=\"modal-header\">
                                                            <h5 class=\"modal-title  fw-bold\" id=\"expeditLabel1111\">Edit Category Event</h5>
                        ...
                        <div class="modal fade" id="addCategory" tabindex="-1"  aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title  fw-bold" id="expeditLabel1111">Add Category Event</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
